        ...
        <div {...props} className={cn('-mx-1', props.className)}>
            <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-primary/15 via-primary/8 to-transparent border border-primary/20 p-4">
                ...
                <div className="relative">
                    ...
                    {/* CTA Button */}
                    <Link
                        href="https://www.e-technostar.com/contact/"
                        className="cursor-pointer group w-full flex items-center justify-between bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg px-3 py-2.5 transition-all duration-200 hover:shadow-md hover:shadow-primary/25"
                    >
