---
title: 'Solving plane stress problem'
id: parts-name-mesh-property
author: TechnoStar Co., Ltd.
author_url: https://www.e-technostar.com/
sidebar_label: Modify parts properties
---

<Callout type="info" title="This sample contains topics as follows:">
- How to get number of parts.
- How to rename parts.
- How to create mesh.
- How to define materials.
- How to use Combo box (GUI)

![Sample1](./assets/Sample1.png)

</Callout>
## How to use the Code
1. Import CAD file or create some parts in a document.
