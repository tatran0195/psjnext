...
- Specify the first value which will be used for converting.

<!-- @since:5.0.1 @required -->
### doubleValue2

- Specify the second value which will be used for converting.

<!-- @since:5.0.1 @required -->
### doubleValue3

- Specify the third value which will be used for converting.
