...
- Specify the coordinates of the starting point of the arrow (e.g., \[x1, y1, z1]).
  - The value is in SI units \[meters].

<!-- @since:5.1.0 @optional -->
### listEndPoint

- Specify the coordinates of the ending point of the arrow (e.g., \[x2, y2, z2]).
  - The value is in SI units \[meters].
...
- Specify the the width of the arrow's shaft in pixels. The default is 1.0.

<!-- @since:5.1.0 @optional -->
### bothSides

- Specify the drawing arrow direction.
