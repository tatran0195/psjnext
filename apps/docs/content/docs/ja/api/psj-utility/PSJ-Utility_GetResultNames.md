...
- Specify the_[BoolType](../data-type/psj-utility/pre-utility/enumeration-types/bool-types)_ specifying whether to use the name of the current language setting.
