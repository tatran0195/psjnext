...
- Specify the_[MessageBoxOptionType](../data-type/psj-utility/pre-utility/enumeration-types/msgbox-option-types)_ describing the message option type to be the default value.
