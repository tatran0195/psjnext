...
- Specify the_[DItemType](../data-type/psj-command/DItem-types)_ describing the type of entity (reference entities here).

<!-- @since:5.1.0 @required -->
### externalID

- Specify external ID of reference item.

<!-- @since:5.1.0 @optional -->
### bUsedRef

- Specify if the target is reference item.
