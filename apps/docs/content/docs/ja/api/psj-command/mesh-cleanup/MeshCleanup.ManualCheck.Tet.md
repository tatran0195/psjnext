...
- Specify the targets to check mesh quality. The targets can be part or solid element.
...
- Specify the safety factor value of elements to be displayed. This argument is used when iElementQualityType = 8, 9, or 10.
