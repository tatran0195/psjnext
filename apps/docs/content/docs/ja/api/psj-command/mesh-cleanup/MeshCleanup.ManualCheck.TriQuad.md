...
- Specify the inequality sign for the threshold value of TRI element.
...
- Specify the threshold value will be used to detect and display the TRI elements violated the specified mesh quality standard.
...
- Specify the safety factor value of TRI elements to be displayed. This argument is used when iElementQualityType = 7, or 8.
- The default value is 1.0.

<!-- @since:5.1.0 @optional -->
### iCheckConditionQuad

- Specify the inequality sign for the threshold value of QUAD element.
  - If iElemQualityType = 0: The default value is 0 (Less than and equal).
  - If iElemQualityType = 1: The default value is 2 (Greater than and equal).
  - If iElemQualityType = 2: The default value is 0 (Less than and equal).
  - If iElemQualityType = 3: The default value is 0 (Less than and equal).
...
- Specify the threshold value will be used to detect and display the QUAD elements violated the specified mesh quality standard
  - If iElemQualityType = 0: The default value is 0.1.
  - If iElemQualityType = 1: The default value is 10.0.
  - If iElemQualityType = 2: The default value is 0.1.
  - If iElemQualityType = 3: The default value is 0.01.
...
- Specify the safety factor value of QUAD elements to be displayed. This argument is used when iElementQualityType = 7, or 8.
- The default value is 1.0.

<!-- @since:5.1.0 @optional -->
### bIncludeDiagonalQuad

- Specify to include diagonal line for QUAD. This argument is used when iElementQualityType = 7 (Time Step (LS-Dyna)).
- The default value is _True_.

<!-- @since:5.1.0 @optional -->
### iNonPrimary

- Specify the non primary.
