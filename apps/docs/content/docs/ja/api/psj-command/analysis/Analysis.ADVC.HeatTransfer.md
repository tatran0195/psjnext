...
- Specify the job name of ADVC analysis. This name would be the name of analysis job in Assembly Tree and the name of ADX file after exported.

<!-- @since:5.0.1 @optional -->
### strDescription

- Specify the description for ADVC analysis job. The description would write in ADX file, where contents will be written below ModelInfo.
- The default value is "".

<!-- @since:5.0.1 @optional -->
### crlProcessSequence

- Specify the ADVC process sequences. This argument controls the Process solution type and its setting information depended on solution type.
- The default value is \[].

<!-- @since:5.0.1 @optional -->
### crlElemLocationGroup

- Specify the element locations. The model contains Element group such as 3D Element, 2D Element, 1D Element to use this argument.
- The default value is \[].

<!-- @since:5.0.1 @optional -->
### crlNodeLocationGroup

- Specify the node locations. The model contains Node group to use this argument.
- The default value is \[].

<!-- @since:5.0.1 @optional -->
### bWriteGroup

- Specify whether to write group which output a selected group of Faces, Elements, Nodes as Surface Segment, Element Set and Node set respectively.
...
- Specify the existing ADVC job in Assembly Tree. If this argument is not _None_, the specified ADVC job will be modified. Otherwise, a new job will be created.
- The default value is _None_.

<!-- @since:5.0.1 @optional -->
### bResultReference

- Specify whether to use the settings of Result Reference.
...
- Specify the method to separate file. This option allows to separate information into many exported ADX files by the specified type.
...
- Specify whether to export all related Load Boundary Condition. This argument is to be used when _iSeparateFile=3_.
...
- Specify whether to use entity name in exported file or not.
...
- Specify the load type used for analysis.
...
- Specify whether to use the same output request for all processes.
...
- Specify whether to delete floating nodes or not.
...
- Specify whether to separate boundary condition. This argument is to be used when _iSeparateFile=3_.
...
- Specify whether to check if duplicate the boundary conditions.
...
- Specify whether to automatically assign dummy property for dummy entities. This argument is to be used when the model has that unassigned property.
...
- Specify the dummy property material for automatically assigning dummy property when export ADX file.
- The default value is _None_.

<!-- @since:5.0.1 @optional -->
### bReferenceRestartData

- Specify whether to use the Reference Restart Data.
...
- Specify the number of processes for Reference Restart Data.
- The default value is DFLT\_INT.

<!-- @since:5.0.1 @optional -->
### iNumberSteps

- Specify the number steps of Reference Restart Data.
- The default value is DFLT\_INT.
...
- Specify whether to update contact search for Reference Restart Data.
...
- Specify the list of load node contacts.
- The default value is \[].

<!-- @since:5.0.1 @optional -->
### iHeatConvection

- Specify the Heat Convection type. There are 2 types of Heat Convection:
...
- Specify the exporting path for ADX file.
- The default value is "".
...
- Specify whether to write geometry ID number.
- The default value is _False_.

<!-- @since:5.0.1 @optional -->
### bSeparatePartInfoFile

- Specify whether to separate Part Information Files.
- The default value is _False_.

<!-- @since:5.0.1 @optional -->
### strADVCTemplateFilePath

- Specify the path of ADVC Template File.
- The default value is "".
