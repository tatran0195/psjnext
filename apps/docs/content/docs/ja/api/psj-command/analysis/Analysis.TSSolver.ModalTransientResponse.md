...
ribbon: "Analysis > TS-Solver > Modal Transient Response(SOL 112)"
---
...
export _status = Analysis.TSSolver.ModalTransientResponse(nastranAnalysis = input _param, 
