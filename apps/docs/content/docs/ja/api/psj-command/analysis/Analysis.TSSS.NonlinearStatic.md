...
- Specify the radial return algorithm used in Nonlinear Static Analysis.
- The default value is DFLT\_INT.

<!-- @since:5.0.1 @optional -->
### listNastranNonlinear

- Specify the Nastran Nonlinear parameter of TechnoStar SunShine solver.
- The default value is \[].
