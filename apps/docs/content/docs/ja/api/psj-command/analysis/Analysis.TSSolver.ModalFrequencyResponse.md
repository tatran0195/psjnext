...
ribbon: "Analysis > TS-Solver > Modal Frequency Response(SOL 111)"
---
...
input _param = NASTRAN _ANALYSIS(iSolverType=3, 
                               ...
                               nastranEigen=NASTRAN _EIGEN(dStartFreq=0.0, 
                                                          dEndFreq=100.0, 
                                                          iNoOfModes=3),
                               nastranFrequency=NASTRAN _FREQUENCY(dStartFrequency=0.0, 
                                                                  dIncrement=10.0, 
                                                                  iumOfInc=10),
...
export _status = Analysis.TSSolver.ModalFrequencyResponse(nastranAnalysis = input _param, 
