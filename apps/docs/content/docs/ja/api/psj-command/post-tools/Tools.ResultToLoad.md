...
- Specify the selected entities. The entities can be Part, Face, Node, Element or Group.
...
- Specify the components of the selected result.
- The default value is RESULT\_LOAD().

<!-- @since:5.1.0 @required -->
### strExportPath

- Specify the path of file to be exported.
