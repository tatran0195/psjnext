...
- Specify a list of the ADVC files (\*.adx files) which will be used for importing.
...
- Specify whether Jupiter enables to read Material, Property, LBC, Contact, Job name, and related group names.
