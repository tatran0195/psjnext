...
- Specify a list of the Universal files (\*.unv file) which will be used for importing.

<!-- @since:5.0.1 @removed:5.1.0 @required @deprecated -->
### strPath

- Specify the path of the Universal file (\*.unv file) which will be used for importing.
