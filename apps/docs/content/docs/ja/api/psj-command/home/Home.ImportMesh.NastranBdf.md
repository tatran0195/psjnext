...
- Specify a list of the Nastran files (\*.bdf files) which will be used for importing.
...
- Specify the option that read name comments for Jupiter.
- The default value is _False_.

<!-- @since:5.0.1 @optional -->
### iCreateDup1DElemAnswer

- Specify the option that creating duplicated 1D element.
  - -1: Unknown
  - 0: No
  - 1: yes
...
import _status = Home.ImportMesh.AnsysDat(strlPaths=[nastran _file _path])
