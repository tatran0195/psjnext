...
- Specify master edges will be retained after operation.

<!-- @since:5.0.1 @required -->
### crlSlave

- Specify slave edges to be stitched.

<!-- @since:5.0.1 @optional -->
### dTolerance

- Specify the stitch tolerance. The free edges are at a distance less than or equal to the specified value will be stitched.
- The default value is 0.3.

<!-- @since:5.0.1 @optional -->
### bKeepSlave

- Specify whether to keep slave nodes after the stitch operation.
