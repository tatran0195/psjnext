...
- Specify either a series of nodes (interpolation points) through which the curve passes. At least three nodes must be specified.

<!-- @since:5.0.1 @optional -->
### crPart

- Specify the part that the spline bar will belong to. If set none, a new bar part will be created.
