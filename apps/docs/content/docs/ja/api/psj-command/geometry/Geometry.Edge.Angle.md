...
- Specify element edges used for automatic selection.
...
- Specify whether to find the adjacent element edges which can be chained to form a circle.
- The default value is _False_.

<!-- @since:5.0.1 @optional -->
### bBreakFace

- Specify whether to break the face which the given element edges lie on where possible.
