...
- Specify the adjacent faces around the Rib or Boss geometry. These faces must be connected to each other.

<!-- @since:5.0.1 @optional -->
### dGradiation

- Specify the gradation value. It defines the rate at which the mesh transitions between high mesh density and low mesh density for the new smooth face. Possible values are greater than or equal to 0.5.
- The default value is 1.0.

<!-- @since:5.0.1 @optional -->
### iContinuity

- Specify the connection continuity factor. It defines the rate at which the smooth shape transition between the bound face and the new smooth face. The possible values that _iContinuity_ can take are 0, 1, and 2.
