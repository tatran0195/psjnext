...
- Specify the faces to be extracted.

<!-- @since:5.0.1 @optional -->
### dFaceAngle

- Specify the angle in degrees between the adjacent faces to be extracted. If _dFaceAngle=-1_, the selected faces are extracted only.
- The default value is 60.0.

<!-- @since:5.0.1 @optional -->
### strName

- Specify the original name of new parts. The final name is a concatenation of the original name and sequence number.
- The default value is "ExtractFace\_1".

<!-- @since:5.0.1 @optional -->
### bMergePart

- Specify whether to merge new parts into a single part.
