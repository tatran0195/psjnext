...
- Specify faces to be trimmed. Either _crlFaces_, or _crlParts_ must be specified.
- The default value is \[].

<!-- @since:5.0.1 @optional -->
### crlParts

- Specify parts to be trimmed. Either _crlFaces_, or _crlParts_ must be specified.
- The default value is \[].

<!-- @since:5.0.1 @optional -->
### dTrimSize

- Specify the maximum length of element edge.
- The default value is 1.0.

<!-- @since:5.0.1 @optional -->
### dTrimAngle

- Specify the maximum angle in degrees between element edges.
