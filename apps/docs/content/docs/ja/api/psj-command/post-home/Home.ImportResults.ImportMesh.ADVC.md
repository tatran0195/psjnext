...
macro _link: "[ImportAdxToPost](../../macro/home/ImportAdxToPost)"
---
...
- Specify an ADVC file (\*.adx file) which will be used for importing.
...
import _status = Home.ImportResults.ImportMesh.ADVC(strPath=advc _file _path)
