...
- Specify the CAD parts. Faces on selected parts will be the referenced faces for projection.
...
- Specify list of meshed faces. Nodes on these faces will be projected onto referenced faces.

<!-- @since:5.0.1 @optional -->
### bForceProject

- Specify whether to force projection or not. If _True_, Jupiter will try to do projection more aggressively, hence may takes more time to finish.
- The default value is _False_.

<!-- @since:5.0.1 @optional -->
### bProjectCornerNodes

- Specify whether to project corner nodes or not. If _True_, corner nodes of elements will be projected.
- The default value is _True_.

<!-- @since:5.0.1 @optional -->
### bProjectMidNodes

- Specify whether to project mid nodes or not. If _True_, mid nodes of elements will be projected.
- The default value is _False_.

<!-- @since:5.0.1 @optional -->
### bIDcheck

- Specify whether to check ID when projecting or not.
