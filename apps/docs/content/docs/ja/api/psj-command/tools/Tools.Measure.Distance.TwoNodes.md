...
- Specify the first node to measure distance.

<!-- @since:5.0.1 @required -->
### crNode2

- Specify the second node to measure distance.

<!-- @since:5.0.1 @optional -->
### strTarget

- Specify the target projection axis, or the three-dimensional space (3D) to refer to measure. This parameter can be one of the following:
...
- Specify the coordinate reference system in which the distance will refer to measure.
