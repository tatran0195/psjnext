...
macro _link: "[CmdMarkupSearchElementFromPoint](../../macro/post/CmdMarkupSearchElementFromPoint)"
---
...
- Specify the coordinates of points to search the nearest elements.
