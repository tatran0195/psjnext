...
- Specify whether to display the node ID in element's notes window.
- The default value is _True_.

<!-- @since:5.1.0 @optional -->
### iNoteElemNodeID

- Specify the method to display the node ID title as default or user-defined name.
  - 0: Default
  - 1: User-Defined
...
- Specify an arbitrary user-defined name for the node ID title. This option was used when _iNoteElemNodeID_= 1.
