...
- Specify whether to display the coordinates of the selected position in the note window.
- The default value is _True_.

<!-- @since:5.1.0 @optional -->
### iNoteResultPos

- Specify the method to display the coordinate title as default or user-defined name.
  - 0: Default
  - 1: User-Defined
...
- Specify an arbitrary user-defined name for the coordinate title. This option was used when _iNoteResultPos_= 1.
