...
- Specify specifying the name of template, which will attach the viewpoint settings.
- The default value is "NewTemplate".

<!-- @since:5.1.0 @optional -->
### postDataVizOptViewPoint

- Specify all settings of a view point.
- The default value is [POST\_DATA\_VIZ\_OPT\_VIEWPOINT](../../data-type/psj-command/parameter-types/POST _DATA _VIZ _OPT _VIEWPOINT).
