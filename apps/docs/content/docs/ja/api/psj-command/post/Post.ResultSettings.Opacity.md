...
- Specify all settings of the opacity display.
- The default value is [POST\_DATA\_VIZ\_OPT\_TRANSPARENCY](../../data-type/psj-command/parameter-types/POST _DATA _VIZ _OPT _TRANSPARENCY).
