...
macro _link: "[CmdMarkupSearchPoint](../../macro/post/CmdMarkupSearchPoint)"
---
...
- Specify the coordinates of points for searching.

<!-- @since:5.1.0 @optional -->
### dTolerance

- Specify the tolerance value for searching.
- The default value is 0.0.

<!-- @since:5.1.0 @optional -->
### bSearch

- Specify whether to search only on the displayed parts or all parts of the model.
