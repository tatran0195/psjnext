...
- Specify the selected nodes to detect max/min value.

<!-- @since:5.1.0 @optional -->
### bCheckMax

- Specify whether to enable/disable detecting and displaying the maximum value.
- The default value is _True_.

<!-- @since:5.1.0 @optional -->
### bCheckMin

- Specify whether to enable/disable detecting and displaying the minimum value.
- The default value is _True_.

<!-- @since:5.1.0 @optional -->
### bSave

- Specify whether to save the detected max/min result into AreaMax/Min tab of the Watch Data Window.
