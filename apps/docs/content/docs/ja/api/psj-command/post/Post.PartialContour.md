...
- Specify the targets to be displayed with contour. The targets can be part, face, bar, node, element, or groups.

<!-- @since:5.1.0 @optional -->
### bUsePartColor

- Specify whether to display part color on the unselected entities.
