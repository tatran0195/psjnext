...
- Specify whether to display the principal stress/principal strain unit vector in the note window.
- The default value is _True_.

<!-- @since:5.1.0 @optional -->
### iNoteResultPrnVector

- Specify the method to display the principal stress/principal strain unit vector title as default or user-defined name.
  - 0: Default
  - 1: User-Defined
...
- Specify an arbitrary user-defined name for the principal stress/principal strain vector. This option was used when _iNoteResultPrnVector_= 1.
