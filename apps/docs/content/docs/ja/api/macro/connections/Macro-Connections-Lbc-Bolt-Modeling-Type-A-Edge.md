---
title: "Lbc _Bolt _Modeling _Type _A_Edge()"
...
```psj
Lbc _Bolt _Modeling _Type _A_Edge(Cursor taEdgeCur1,TCursor taEdgeCur2,string strRbeName,
    ...
    int nBotSlot,double dRBE2, bool IsCreate2ADVCStaticProcessForFixLength)
```
...
```psj
Lbc _Bolt _Modeling _Type _A_Edge([5:66319], [5:10000031], "RBE", "Bar _2", 0, 0:0, 20,
