---
title: "Lbc _Bolt _Modeling _Type _A_Face()"
...
```psj
Lbc _Bolt _Modeling _Type _A_Face(Cursor taFaceCur1,Cursor taFaceCur2,string strRbeName,
...
```psj
Lbc _Bolt _Modeling _Type _A_Face([6:60], [6:49], "RBE", "Bar _1", 1, 0:0, 20.0002, 0.1,
