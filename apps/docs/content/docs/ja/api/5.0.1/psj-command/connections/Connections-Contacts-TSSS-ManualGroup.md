...
- A _[SUNSHINE_CONTACT](/docs/cli/5.0.1/data-type/psj-command/parameter-types/SUNSHINE_CONTACT)_ specifying the Sunshine contact parameters.
- The default value is _[SUNSHINE_CONTACT](/docs/cli/5.0.1/data-type/psj-command/parameter-types/SUNSHINE_CONTACT)_.
