...
- A _[SURFACE_MESH](/docs/cli/5.0.1/data-type/psj-command/parameter-types/SURFACE_MESH)_ specifying the mesh.
- The default value is _[SURFACE_MESH](/docs/cli/5.0.1/data-type/psj-command/parameter-types/SURFACE_MESH)_.
