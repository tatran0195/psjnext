...
Macro: [ExportAbaqusInp](/docs/cli/5.0.1/macro/analysis/ExportAbaqusInp)
...
- A _Cursor_ specifying the created Abaqus job using [Analysis.Abaqus()](/docs/cli/5.0.1/psj-command/analysis/Analysis.Abaqus) function.
