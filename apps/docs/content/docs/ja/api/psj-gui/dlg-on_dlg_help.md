...
def on _button _Help _clicked(dlg):
...
def main():
    ...
    dlg.add _label(name="Label2",text="Please click on Help button!",layout="Layout1")
    dlg.generate _window()
    dlg.on _dlg _help(callfunc=on _button _Help _clicked)
