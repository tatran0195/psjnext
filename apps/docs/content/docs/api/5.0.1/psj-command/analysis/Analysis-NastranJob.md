...
Macro: [NastranJob](/docs/cli/5.0.1/macro/analysis/NastranJob)
...
- An _[NASTRAN_ANALYSIS](/docs/cli/5.0.1/data-type/psj-command/parameter-types/NASTRAN_ANALYSIS)_ specifying the Nastran analysis input parameter.
