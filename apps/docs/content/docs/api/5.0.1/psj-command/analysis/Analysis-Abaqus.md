...
Macro: [CreateAbaqusJob](/docs/cli/5.0.1/macro/analysis/CreateAbaqusJob)
...
- A _[JOB_ABAQUS_DATA](/docs/cli/5.0.1/data-type/psj-command/parameter-types/JOB_ABAQUS_DATA)_ specifying the Abaqus Analysis input parameter.
- The default value is _[JOB_ABAQUS_DATA](/docs/cli/5.0.1/data-type/psj-command/parameter-types/JOB_ABAQUS_DATA)_.
