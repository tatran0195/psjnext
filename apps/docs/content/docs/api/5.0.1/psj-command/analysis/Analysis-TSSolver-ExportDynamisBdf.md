...
Macro: [ExportDynamisBdf](/docs/cli/5.0.1/macro/analysis/ExportDynamisBdf)
...
- A _Cursor_ specifying the _[Analysis.TSSolver.Job](/docs/cli/5.0.1/psj-command/analysis/Analysis.TSSolver.Job)_.
- This is a required input.
