---
title: "dlg.add _3delement _selector()"
...
```psj
dlg.add _3delement _selector(...)
```

## Inputs

<!-- @since:5.1.0 @type:String @optional @default:"Solid Element" -->
### `text`
...
def main():
    ...
    dlg.add _space(orientation="horizontal",layout="footer")
    dlg.add _3delement _selector(text="3D Element 1")
