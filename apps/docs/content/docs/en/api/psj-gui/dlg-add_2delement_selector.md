---
title: "dlg.add _2delement _selector()"
...
```psj
dlg.add _2delement _selector(...)
```

## Inputs

<!-- @since:5.1.0 @type:String @optional @default:"Element" -->
### `text`
...
def main():
    ...
    dlg.add _space(orientation="horizontal",layout="footer")
    dlg.add _2delement _selector(text="2D Element 1")
