---
title: "dlg.add _coordinate _selector()"
...
```psj
dlg.add _coordinate _selector(...)
```

## Inputs

<!-- @since:5.1.0 @type:String @optional @default:"Coordinate" -->
### `text`
...
def main():
    ...
    dlg.add _space(orientation="horizontal",layout="footer")
    dlg.add _coordinate _selector(text = "Coordinate 1")
