...
Add "1D element" to the selection list, allowing user to select 1D elements and store the selected 1D elements to the
selection list.
...
### `text` @type(String) @default("1D element") @since(5.1.0)
