---
title: "dlg.is _table _cell _combobox()"
...
def on _cell _button _clicked(dlg,name,cell):
    ...
    if cellvector.size() > 0:
       check _cell _combobox = \
            dlg.is _table _cell _combobox(name="Table2",
                cell=cellvector[0])
       print("Is combobox cell: " + str(check _cell _combobox))
...
def main():
    ...
    dlg.set _cell _value(name="Table2",row=0,col=0,
