...
- A _[BASIC](/docs/cli/5.0.1/data-type/psj-command/parameter-types/BASIC)_ specifying the Ansys Analysis - Linear Static Structure input parameter.
- The default value is [BASIC](/docs/cli/5.0.1/data-type/psj-command/parameter-types/BASIC).
...
- A _[STEADY_STATIC](/docs/cli/5.0.1/data-type/psj-command/parameter-types/STEADY_STATIC)_ specifying the Ansys Analysis - Steady Static Heat Transfer input parameter.
- The default value is [STEADY_STATIC](/docs/cli/5.0.1/data-type/psj-command/parameter-types/STEADY_STATIC).
