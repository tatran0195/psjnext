...
Create TechnoStar Solver Job which is necessary for _[Analysis.TSSolver.ExportDynamisBdf](/docs/cli/5.0.1/psj-command/analysis/Analysis.TSSolver.ExportDynamisBdf)_.
...
Macro: [DynamisJob](/docs/cli/5.0.1/macro/analysis/DynamisJob)
...
- A _[NASTRAN_ANALYSIS](/docs/cli/5.0.1/data-type/psj-command/parameter-types/NASTRAN_ANALYSIS)_ specifying the TechnoStar solver input parameter.
- The default value is _[NASTRAN_ANALYSIS](/docs/cli/5.0.1/data-type/psj-command/parameter-types/NASTRAN_ANALYSIS)_.
