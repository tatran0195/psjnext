...
Macro: [ContactMSCNastran](/docs/cli/5.0.1/macro/connections/ContactMSCNastran)
...
- A _[NASTRAN_CONTACT](/docs/cli/5.0.1/data-type/psj-command/parameter-types/NASTRAN_CONTACT)_ specifying the Nastran contact parameters.
- The default value is _[NASTRAN_CONTACT](/docs/cli/5.0.1/data-type/psj-command/parameter-types/NASTRAN_CONTACT)_.
