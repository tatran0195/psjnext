---
id: Connections.MPC.General.NodeToNode
...
Macro: [Mpc](/docs/cli/5.0.1/macro/connections/Mpc)
...
- A _List of [MPC_CONNECTION](/docs/cli/5.0.1/data-type/psj-command/parameter-types/MPC_CONNECTION)_ specifying the list of MPC connection.
