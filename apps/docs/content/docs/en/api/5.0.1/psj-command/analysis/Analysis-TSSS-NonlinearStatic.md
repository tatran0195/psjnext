...
- A _[NASTRAN_ANALYSIS](/docs/cli/5.0.1/data-type/psj-command/parameter-types/NASTRAN_ANALYSIS)_ specifying the TechnoStar Sunshine solver input parameter.
...
- A _[NASTRAN_NONLINEAR](/docs/cli/5.0.1/data-type/psj-command/parameter-types/NASTRAN_NONLINEAR)_ _list_ specifying the Nastran Nonlinear parameter of TechnoStar SunShine solver.
- The default value is [].
