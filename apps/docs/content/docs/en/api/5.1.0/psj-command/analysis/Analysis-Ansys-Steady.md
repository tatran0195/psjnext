...
- A _[BASIC](/docs/cli/5.1.0/data-type/psj-command/parameter-types/BASIC)_ specifying the Ansys Analysis - Linear Static Structure input parameter.
...
- A _[STEADY_STATIC](/docs/cli/5.1.0/data-type/psj-command/parameter-types/STEADY_STATIC)_ specifying the Ansys Analysis - Steady Static Heat Transfer input parameter.
- The default value is [STEADY_STATIC](/docs/cli/5.1.0/data-type/psj-command/parameter-types/STEADY_STATIC).
