...
<!-- @since:5.0.1 @type:PostDataRangeType @required -->
### `PostDataRangeType`

- The _[PostDataRangeType](../data-type/psj-utility/post-utility/enumeration-types/post-data-range-types)_ describing the condition to get the element results.
...
<!-- @since:5.0.1 @type:Double @optional @default:10E-5 -->
<!-- @since:5.1.0 @default:1E-5 -->
### `adjustment`
