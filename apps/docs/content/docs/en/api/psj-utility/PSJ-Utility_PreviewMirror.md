...
- The object or _List of [DBody](../data-type/psj-utility/pre-utility/built-in-types/DBody)_ objects storing the information of parts to be mirrored.

<!-- @since:5.0.1 @type:List[TVector3D] @required -->
### `veclPoint`

- The object specifying 3 node’s position to form a mirror plane.
