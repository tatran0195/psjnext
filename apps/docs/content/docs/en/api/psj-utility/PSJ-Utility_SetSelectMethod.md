...
<!-- @since:5.0.1 @type:SelectMethodType @required -->
### `selectMethodType`

- The _[SelectMethodType](../data-type/psj-utility/pre-utility/enumeration-types/select-method-types)_ describing the selection method.
