...
<!-- @since:5.1.0 @type:Any @required -->
### `documentName`

- Document to close graph views that belongs to.
...
samplePath1=JPT.GetProgramPath() + '\\SampleData\\PSJ\\PSJ-Utility\\PostSample\\101 _solid.op2'
...
samplePath2=JPT.GetProgramPath() + '\\SampleData\\PSJ\\PSJ-Utility\\PostSample\\103 _solid.op2'
...
JPT.CloseGraphViewByDocumentName('101 _solid')
```
