...
<!-- @since:5.1.0 @type:MessageConsoleType @required -->
### `messageType`

- The _[MessageConsoleType](../data-type/psj-utility/pre-utility/enumeration-types/msg-console-types)_ describing the message type to be hidden.
