...
<!-- @since:5.0.1 @type:ElemKind @required -->
### `ElemKind`

- The _[ElemKind](../data-type/psj-command/element-types)_ of elements in Jupiter.
...
list2DElems = JPT.GetElemsByKind(JPT.ElemKind.ELEMKIND _2D)
