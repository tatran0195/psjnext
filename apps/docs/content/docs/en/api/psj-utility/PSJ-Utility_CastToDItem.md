...
<!-- @since:5.0.1 @type:Object @required -->
### `Object`

- The in Jupiter such as_[DBody](../data-type/psj-utility/pre-utility/built-in-types/DBody)_, _[DFace](../data-type/psj-utility/pre-utility/built-in-types/DFace)_, _[DElem](../data-type/psj-utility/pre-utility/built-in-types/DElem)_, _[DEdge](../data-type/psj-utility/pre-utility/built-in-types/DEdge)_, _[DGroup](../data-type/psj-utility/pre-utility/built-in-types/DGroup)_, _[DNode](../data-type/psj-utility/pre-utility/built-in-types/DNode)_, etc.
