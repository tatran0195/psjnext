...
<!-- @since:5.0.1 @type:MsgBoxType @required -->
### `messageBoxType`

- The _[MsgBoxType](../data-type/psj-utility/pre-utility/enumeration-types/msgbox-types)_ describing the type of creating message box in Jupiter.
