...
- The list of CAD edges.

<!-- @since:5.0.1 @type:List[Cursor] @required -->
### `crlBarEdge`

- The list of bar edges.

<!-- @since:5.0.1 @type:List[Cursor] @required -->
### `crlBarPart`

- The list of bar parts./
...
- The desired number of elements. If this parameter is bigger than 0 ,`dDocMeshSize` is ignored.
