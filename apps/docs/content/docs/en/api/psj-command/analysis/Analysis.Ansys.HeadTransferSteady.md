...
<!-- @since:5.0.1 @type:Integer @optional @default:64 -->
...
<!-- @since:5.0.1 @type:Double @optional @default:1.1 -->
...
<!-- @since:5.0.1 @type:Double @optional @default:0.25250625 -->
### `dTransientdataFalpha`

- The transient data alpha.

<!-- @since:5.0.1 @type:Double @optional @default:0.505 -->
