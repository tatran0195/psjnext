...
<!-- @since:5.0.1 @type:ABAQUS _LBC _STEP _INFO @optional @default:[] -->
### `listAbaqusLbcStepInfo`

- The _list_ specifying the list of Abaqus steps from load boundary condition information.
...
creating _status = Analysis.ModifyLbcToStep(listAbaqusLbcStepInfo=[ABAQUS _LBC _STEP _INFO(crStep=AbaqStepsStructStatic(1),
                                                                                       crLbc=LbcConstraint(1),
                                                                                       iCurflag=2),
                                                                  ABAQUS _LBC _STEP _INFO(crStep=AbaqStepsStructStatic(1),
