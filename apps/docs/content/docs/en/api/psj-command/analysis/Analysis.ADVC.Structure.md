...
- The job name of ADVC analysis. This name would be the name of analysis job in Assembly Tree and the name of the ADX file after exported.

<!-- @since:5.0.1 @type:String @optional @default:"" -->
### `strDescription`

- The description for ADVC analysis job. The description would write in the ADX file, where contents will be written below ModelInfo.
...
- The list of ADVC process sequence. This argument controls the Process solution type and its setting information depended on solution type.

<!-- @since:5.0.1 @type:List[Cursor] @optional @default:[] -->
### `crlElemLocationGroup`

- The list of element location. The model contains element group such as 3D Element, 2D Element, 1D Element to use this argument.

<!-- @since:5.0.1 @type:List[Cursor] @optional @default:[] -->
### `crlNodeLocationGroup`

- The list of node location. The model contains node group to use this argument.

<!-- @since:5.0.1 @type:Boolean @optional @default:False -->
### `bWriteGroup`

- The to be enable/disable the write group option which output a selected group of faces, elements, nodes as Surface Segment, Element Set and Node set respectively.
...
- An existing ADVC job in Assembly Tree to modify it. If this parameter is used, the specified ADVC job will be modified. If it is left _None_, a new ADVC job will be created.

<!-- @since:5.0.1 @type:Boolean @optional @default:False -->
### `bResultReference`

- The to be enable/disable the Result Reference option is defined or not.
...
- The separate file type. This option allows to separate information into many exported ADX files by selected type.
...
- The to be enable/disable the option that export all related Load Boundary Condition. This option could be used when _iSeparateFile=3_(By Selected Body), if not, this setting is not activated for both _True_ or _False_.
...
- The to be enable/disable the option that use entity name in exported file or not.
...
- The to be enable/disable the option that the Matrix Solver Parameter is defined ot not.
...
- The load type uses for analysis.
...
- The to be enable/disable the same output request for all processes.
...
- The to be enable/disable the option that would delete floating node or not.
...
- The to be enable/disable the option that would separate boundary condition. This option could be used when _iSeparateFile=3_ (By Selected Body), if not, this setting is not activated for both _True_ or _False_.
...
- The to be enable/disable checking whether boundary conditions are duplicated or not.
...
- The to be enable/disable automatically assign dummy property option. This option used when model that has not assign property yet. If the model already has property
...
- The dummy property material for automatically assigning dummy property when export the ADX file.

<!-- @since:5.0.1 @type:Boolean @optional @default:False -->
### `bReferenceRestartData`

- The to be enable/disable the Reference Restart Data is defined or not.
...
- The number of process for Reference Restart Data.

<!-- @since:5.0.1 @type:Integer @optional @default:DFLT _INT -->
### `iReferenceRestartDataStepNum`

- The number of Reference Restart Data step.
...
- The update contact search for Reference Restart Data.
...
- The option that creates process for bolt fixed length.
...
- The exporting path for the ADX file.

<!-- @since:5.0.1 @type:Integer @optional @default:0 -->
### `iNumType`

- The numeric format type. This argument would allow numeric setting type of the ADX file.
...
- The limitation number of digits before the point of the number. This option allows to control number digits of value in the exported ADX file.

<!-- @since:5.0.1 @type:Integer @optional @default:1 -->
### `iUiPrecision`

- The limitation number of digits after the point of the number. This option allows to control number digits of value in the exported ADX file.

<!-- @since:5.0.1 @type:Boolean @optional @default:False -->
### `bExportGeometryID`

- The to be enable/disable the write geometry ID number.

<!-- @since:5.0.1 @type:Boolean @optional @default:False -->
### `bSeparatePartInfoFile`

- The to be enable/disable the option that separate Part Information Files.
...
- The job type (Structure = 0)

<!-- @since:5.1.0 @type:Vector @optional -->
