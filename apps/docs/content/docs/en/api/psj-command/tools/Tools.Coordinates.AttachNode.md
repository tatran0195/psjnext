...
- An existing Coordinate System to modify. If the`bCreateNew` is _False_, this specified Coordinate will be moved to the node specified in `crNode`, while `bCreateNew` is _True_, a new Coordinate will be created.
