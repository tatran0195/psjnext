...
<!-- @since:5.0.1 @type:List[Vector] @optional @default:[] -->
### `veclPoints`
...
- An existing Coordinate. If this parameter is used, the specified Coordinate will be modified. If it is left _None_, a new Coordinate will be created.
