...
- Whether to copy load boundary conditions from the existing part to new parts. This argument will only affect the functionality when _bCreateNewPart=True_.

<!-- @since:5.0.1 @type:Boolean @optional @default:False -->
### `bCopyProperty`

- The selecting whether to copy property from the existing part to new parts. This argument will only affect the functionality when _bCreateNewPart=True_.
