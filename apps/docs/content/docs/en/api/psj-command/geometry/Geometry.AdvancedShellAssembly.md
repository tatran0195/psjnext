...
- The parts to assemble. Either _crlParts_ or _crlFace_ must be specified.

<!-- @since:5.0.1 @type:List[Cursor] @optional @default:[] -->
### `crlFaces`

- The faces to assemble. Either _crlParts_ or _crlFace_ must be specified.
...
- The how to connect between faces.
...
<!-- @since:5.0.1 @type:Double @optional @default:2.1 -->
### `dGapTol`
