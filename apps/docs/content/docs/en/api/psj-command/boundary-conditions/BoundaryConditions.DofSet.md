...
<!-- @since:5.0.1 @type:String @optional @default:"DofSet1" -->
### `strName`
...
- An existing DoF Set. If this parameter is used, the specified DoF Set will be modified. If it is left _None_, a new DoF Set will be created.
