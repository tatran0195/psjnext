...
### `bVolumeCheck` @type(Boolean) @default(0)

- To check the Volume quality.

### `bJacobFactorCheck` @type(Boolean) @default(0)

- To check the Jacobian Factor quality.

### `bTetCollapseCheck` @type(Boolean) @default(0)

- To check the Tet collapse quality.

### `bTetSkewCheck` @type(Boolean) @default(0)

- To check the Tet Skewness quality.
...
### `dVolumeLimit` @type(Double) @default(0)
...
### `dJacobFactorLimit` @type(Double) @default(0)
...
### `dTetCollapseLimit` @type(Double) @default(0.05)
...
### `dTetSkewLimit` @type(Double) @default(0.9)
