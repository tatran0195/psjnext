...
macro_link: "[LbcContactAdvc_ContactGroupByMatrix](../../macro/connections/LbcContactAdvc_ContactGroupByMatrix)"
---
<!-- REVIEW FLAGS — requires human review
   [param_decorator_changed] Param 'iMethod' @default changed from '0' to '(none)' in v5.1.0
     context: {"param":"iMethod","fromVersion":"5.0.1","toVersion":"5.1.0","fromDefault":"0"}
