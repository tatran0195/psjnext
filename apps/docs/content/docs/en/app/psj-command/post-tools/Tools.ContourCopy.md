...
macro_link: "[ContourCopy](../../macro/tools/ContourCopy)"
---
...
### `strPostDocName` @type(String) @required

- The Post document name to copy the contour.

### `strPreDocName` @type(String) @required

- The Pre document name to be copied the contour.
