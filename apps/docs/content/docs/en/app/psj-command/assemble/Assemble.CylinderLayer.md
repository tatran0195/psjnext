...
macro_link: "[CylinderLayer](../../macro/assemble/CylinderLayer)"
---
...
- The list of cylindrical face.

### `crNode` @type(Cursor) @default(None)

- The node that determines the face and the length including the extension you want for the edge.
