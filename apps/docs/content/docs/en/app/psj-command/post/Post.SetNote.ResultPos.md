...
macro_link: "[SetNoteResultPos](../../macro/post/SetNoteResultPos)"
---
...
### `bNoteResultPos` @type(Boolean) @default(True)

- Whether to display the coordinates of the selected position in the note window.

### `iNoteResultPos` @type(Integer) @default(0)

- The method to display the coordinate title as default or user-defined name.
  - 0: Default
  - 1: User-Defined

### `strNoteResultPos` @type(String) @default("")

- An arbitrary user-defined name for the coordinate title. This option was used whe&#x6E;_&#x69;NoteResultPos_= 1.
