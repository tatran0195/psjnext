...
macro_link: "[SetNoteResultUnit](../../macro/post/SetNoteResultUnit)"
---
...
### `bNoteResultUnit` @type(Boolean) @default(True)

- Whether to display the unit of data in the note window.
