...
macro_link: "[SetNoteResultDisp](../../macro/post/SetNoteResultDisp)"
---
...
### `bNoteResultDisp` @type(Boolean) @default(True)

- Whether to display the displacement result in notes window.

### `iNoteResultDisp` @type(Integer) @default(0)

- The method to display the displacement result title as default or user-defined name.
  - 0: Default
  - 1: User-Defined

### `strNoteResultDisp` @type(String) @default("")

- An arbitrary user-defined name for the displacement result title. This option was used whe&#x6E;_&#x69;NoteResultDisp_= 1.
