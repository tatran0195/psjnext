...
ribbon: "Post > OptimizationToolkit > EnableOptimizationMode"
macro_link: "EnableOptimizationRenderMode"
---
...
### `bOptimizationMode` @type(Boolean) @default(True)

- Whether or not enables optimization mode.
