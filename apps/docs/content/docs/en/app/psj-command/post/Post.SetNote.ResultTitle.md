...
macro_link: "[SetNoteResultTitle](../../macro/post/SetNoteResultTitle)"
---
...
### `bNoteResultTitle` @type(Boolean) @default(True)

- Whether to display the entire component title in the note window.
