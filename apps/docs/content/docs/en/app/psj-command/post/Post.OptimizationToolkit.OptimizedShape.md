...
macro_link: "[SetHidingElementFactor](../../macro/post/SetHidingElementFactor)"
---
...
### `dTopologyDensity` @type(Double) @default(0.0)

- The threshold value for topology density.

### `strOption` @type(String) @default("NodalDensityRatio")
