...
macro_link: "[SetNoteResultSubID](../../macro/post/SetNoteResultSubID)"
---
...
### `bNoteResultSubID` @type(Boolean) @default(True)

- Whether to display the subcase ID in the note window.
