...
macro_link: "[SetNoteElementPropID](../../macro/post/SetNoteElementPropID)"
---
...
### `bNoteElemPropID` @type(Boolean) @default(True)

- Whether to display the property ID in element's notes window.

### `iNoteElemPropID` @type(Integer) @default(0)

- The method to display the property ID title as default or user-defined name.
  - 0: Default
  - 1: User-Defined

### `strNoteElemPropID` @type(String) @default("")

- An arbitrary user-defined name for the property ID title. This option was used whe&#x6E;_&#x69;NoteElemPropID_= 1.
