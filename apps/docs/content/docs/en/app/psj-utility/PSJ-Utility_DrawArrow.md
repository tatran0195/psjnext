...
- The the width of the arrow's shaft in pixels. The default is 1.0.
...
- The default valuei&#x73;_&#x46;alse_.

### `threeDArrow` @type(Bool) @default(True)
