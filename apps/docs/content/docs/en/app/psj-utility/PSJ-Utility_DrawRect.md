...
- The x-coordinate of the left edge of the rectangle, in pixels.

### `top` @type(Int)

- The Y-coordinate of the top edge of the rectangle, in pixels.

### `right` @type(Int)

- The x-coordinate of the right edge of the rectangle, in pixels.

### `bottom` @type(Int)

- The y-coordinate of the bottom edge of the rectangle, in pixels.
