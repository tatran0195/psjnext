...
- Th&#x65;_[DItemType](../data-type/psj-command/DItem-types)_&#x6F;f BODY, FACE, ELEMENT, EDGE, or NODE entity in Jupiter.

### `itemID` @type(Integer) @required

- The ID of the target entity.

### `DCoord` @type(DCoord) @required

- Object specifying Coordinate System which will be used to convert.
