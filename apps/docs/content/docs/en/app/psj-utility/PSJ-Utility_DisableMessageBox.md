...
### `messageOptionType` @type(Enum) @required

- Th&#x65;_[MessageBoxOptionType](../data-type/psj-utility/pre-utility/enumeration-types/msgbox-option-types)_&#x64;escribing the message option type to be the default value.
