...
### `posX` @type(Double) @required

- The X coordinate of the specified point (node).

### `posY` @type(Double) @required

- The Y coordinate of the specified point (node).

### `posZ` @type(Double) @required

- The Z coordinate of the specified point (node).
