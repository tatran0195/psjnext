...
Macro: [AdvcSSHProcess](/docs/cli/5.0.1/macro/analysis/AdvcSSHProcess)
...
- An _[ADVC_HEAT_TIME_STEP](/docs/cli/5.0.1/data-type/psj-command/parameter-types/ADVC_HEAT_TIME_STEP)_ specifying the setting of Heat Transfer - Steady State parameters such as End Condition, Incrementation, Output Timing Definition.
