...
- An _[ABAQUS_PAIR](/docs/cli/5.0.1/data-type/psj-command/parameter-types/ABAQUS_PAIR)_ specifying the maximum value of the allowable temperature change.
- The default value is _[ABAQUS_PAIR](/docs/cli/5.0.1/data-type/psj-command/parameter-types/ABAQUS_PAIR)_.

### `abaqusPair2`

- A _[ABAQUS_PAIR](/docs/cli/5.0.1/data-type/psj-command/parameter-types/ABAQUS_PAIR)_ specifying the creep/swelling/viscoelastic strain error tolerance value.
- The default value is _[ABAQUS_PAIR](/docs/cli/5.0.1/data-type/psj-command/parameter-types/ABAQUS_PAIR)_.
...
- An _[ABAQUS_OUTPUT_REQUEST](/docs/cli/5.0.1/data-type/psj-command/parameter-types/ABAQUS_OUTPUT_REQUEST)_ list specifying the list of Abaqus output request.
- The default value is _[ABAQUS_OUTPUT_REQUEST](/docs/cli/5.0.1/data-type/psj-command/parameter-types/ABAQUS_OUTPUT_REQUEST)_.
