...
- A _[FORCE_LBC](/docs/cli/5.0.1/data-type/psj-command/parameter-types/FORCE_LBC)_ specifying the general force parameters.
- The default value is _[FORCE_LBC](/docs/cli/5.0.1/data-type/psj-command/parameter-types/FORCE_LBC)_.
