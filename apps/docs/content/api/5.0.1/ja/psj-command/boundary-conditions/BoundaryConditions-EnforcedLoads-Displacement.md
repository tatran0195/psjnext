...
- A _Cursor_ specifying the table created from _[BoundaryConditions.FieldData](/docs/cli/5.0.1/psj-command/boundary-conditions/BoundaryConditions.FieldData)_ function.
- The default value is _None_.

### `crNodeSet`

- A _Cursor_ specifying the node set table created from _[BoundaryConditions.FieldData](/docs/cli/5.0.1/psj-command/boundary-conditions/BoundaryConditions.FieldData)_ function.
- The default value is _None_.
...
- A _Cursor_ specifying the phase table created from _[BoundaryConditions.FieldData](/docs/cli/5.0.1/psj-command/boundary-conditions/BoundaryConditions.FieldData)_ function.
- The default value is _None_.
