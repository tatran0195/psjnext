...
- An _[ABAQUS_LBC_STEP_INFO](/docs/cli/5.0.1/data-type/psj-command/parameter-types/ABAQUS_LBC_STEP_INFO)_ _list_ specifying the list of Abaqus steps from load boundary condition information.
