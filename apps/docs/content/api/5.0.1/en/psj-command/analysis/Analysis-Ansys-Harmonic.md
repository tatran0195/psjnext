...
- A _[HARMONIC](/docs/cli/5.0.1/data-type/psj-command/parameter-types/HARMONIC)_ specifying the Ansys Analysis - Hamonic Structural input parameter.
- The default value is [HARMONIC](/docs/cli/5.0.1/data-type/psj-command/parameter-types/HARMONIC).
...
- A _[MODAL](/docs/cli/5.0.1/data-type/psj-command/parameter-types/MODAL)_ specifying the Ansys Analysis - Modal Structural input parameter.
- The default value is [MODAL](/docs/cli/5.0.1/data-type/psj-command/parameter-types/MODAL).
