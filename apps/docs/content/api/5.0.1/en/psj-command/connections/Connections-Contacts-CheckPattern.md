...
A _Boolean_ specifying whether the mesh is coincide or not:

- _True_: The mesh pattern between the selected entities is matched.
- _False_: The mesh pattern between the selected entities isn't match.
