...
- An _[ANSYS_CONTACT](/docs/cli/5.0.1/data-type/psj-command/parameter-types/ANSYS_CONTACT)_ specifying the Ansys contact properties.
- The default value is _[ANSYS_CONTACT](/docs/cli/5.0.1/data-type/psj-command/parameter-types/ANSYS_CONTACT)_.
