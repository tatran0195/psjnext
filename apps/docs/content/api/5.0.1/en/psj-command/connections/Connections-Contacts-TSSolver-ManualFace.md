...
- A _List of [TSSOLVER_CONTACT](/docs/cli/5.0.1/data-type/psj-command/parameter-types/TSSOLVER_CONTACT)_ specifying the TSSolver contact parameters.
- The default value is _[TSSOLVER_CONTACT](/docs/cli/5.0.1/data-type/psj-command/parameter-types/TSSOLVER_CONTACT)_.
