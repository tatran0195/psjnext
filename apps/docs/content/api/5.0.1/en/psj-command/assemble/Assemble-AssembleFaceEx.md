...
User inputs the pair faces output from [Assemble.FindMatingFaceEx()](/docs/cli/5.0.1/psj-command/assemble/Assemble.FindMatingFaceEx) function, then it will return a list of new shared faces ID created.
