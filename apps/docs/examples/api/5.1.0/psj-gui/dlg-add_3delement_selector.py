...
# Desc:    Add "Solid element" to the selection list, allowing user to select solid elements and store the selected solid elements to the selection list
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-gui/dlg-add_3delement_selector
# ---
from pyjdg import *
...
def main():
    ...
    dlg.add_space(orientation="horizontal",layout="footer")
    dlg.add_3delement_selector(text="3D Element 1")  # [hl]
    dlg.generate_window()
