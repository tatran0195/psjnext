...
# Desc:    Run a created function after a selector is activated.
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-gui/dlg-on_activate_selector
# ---
from pyjdg import *
...
def main():
    ...
    dlg.on_activate_selector(on_activate_selector)  # [hl]
