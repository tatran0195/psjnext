...
# Desc:    Show tooltip when user hover the mouse to a UI component
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-gui/dlg-show_tooltip
# ---
from pyjdg import *
...
def main():
    ...
    dlg.add_space(orientation="horizontal",layout="footer")
    dlg.generate_window()
    dlg.show_tooltip(name="Label1",tip="Tooltip for Label1")  # [hl:start]
    ...
    dlg.show_tooltip(name="Slider9",tip="Tooltip for Slider9")  # [hl:end]
