...
# Desc:    Add "Edge" to the selection list, allowing user to select edges and store the selected edges to the selection list
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-gui/dlg-add_edge_selector
# ---
from pyjdg import *
...
def main():
    ...
    dlg.add_space(orientation="horizontal",layout="footer")
    dlg.add_edge_selector(text="Edge 1")  # [hl]
    dlg.generate_window()
