...
# Desc:    Add "1D element" to the selection list, allowing user to select 1D elements and store the selected 1D elements to the selection list
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-gui/dlg-add_1delement_selector
# ---
from pyjdg import *
...
def main():
    ...
    dlg.add_space(orientation="horizontal",layout="footer")
    dlg.add_1delement_selector(text="1D Element 1")  # [hl]
    dlg.generate_window()
