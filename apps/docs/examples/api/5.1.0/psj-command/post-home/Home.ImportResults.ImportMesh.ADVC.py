...
# Desc:    Import an ADVC file to the Jupiter Database as Post document.
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/post-home/Home.ImportResults.ImportMesh.ADVC
# ---
...
import_status = Home.ImportResults.ImportMesh.ADVC(strPath=advc_file_path)  # [hl]
