...
# Desc:    Display result contour of Draft Angle function.
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/tools/Tools.DraftAngleShowContour
# ---
#Create Sample Model
...
Tools.DraftAngleShowContour(listPairCursorData=draft_angle_result)  # [hl]

#Show result with different parameter 
Tools.DraftAngleShowContour(  # [hl:start]
    listPairCursorData=draft_angle_result, 
    iDivisionNumber=5, dContourMax=60, dContourMin=-60)  # [hl:end]
