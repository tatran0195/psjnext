...
# Desc:    Create a Measure Note for Measure > Mass > By Material
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/tools/Tools.Measure.Mass.CreateMeasureNote.Material
# ---
#Preapre model
...
Tools.Measure.Mass.CreateMeasureNote.Material(  # [hl:start]
    strNoteName="Mass1", 
    crlParts=[Part(1)], 
    dDensity=8300)  # [hl:end]
