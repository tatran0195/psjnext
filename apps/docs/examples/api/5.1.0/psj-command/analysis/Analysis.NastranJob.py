...
# Desc:    Create a Nastran Analysis Job
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/analysis/Analysis.NastranJob
# ---
...
exported_job = Analysis.NastranJob(nastranAnalysis = nastran_param,   # [hl]
                                   iDummyPropMaterialID=5)  # [hl]
