...
# Desc:    Export TechnoStar Nonlinear Static solver file (SOL 106)
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/analysis/Analysis.TSSolver.NonlinearStatic
# ---
...
export_status = Analysis.TSSolver.NonlinearStatic(nastranAnalysis = input_param,   # [hl]
