...
# Desc:    Create TechnoStar Solver Job which is necessary for Analysis.TSSolver.ExportDynamisBdf
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/analysis/Analysis.TSSolver.Job
# ---
...
created_job = Analysis.TSSolver.LinearStatic(nastranAnalysis = dynamic_param)  # [hl]
