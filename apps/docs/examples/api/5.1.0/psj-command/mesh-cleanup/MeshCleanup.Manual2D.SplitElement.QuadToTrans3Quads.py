...
# Desc:    Convert a single quadrilateral element into three triangular elements.
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/mesh-cleanup/MeshCleanup.Manual2D.SplitElement.QuadToTrans3Quads
# ---
