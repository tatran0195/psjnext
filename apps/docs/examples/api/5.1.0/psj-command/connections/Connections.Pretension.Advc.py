...
# Desc:    Create bolt pretension for the ADVC solver
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/connections/Connections.Pretension.Advc
# ---
...
creating_status = Connections.Pretension.Advc(crlTargets=[Face(8)],   # [hl]
                                              dForceValue=1.0,   # [hl]
                                              dlForceDirection=[0.0, -1.0, 0.0],   # [hl]
                                              dlControlNode=[0.001419156, 0.02, 0.00012416],  # [hl]
                                              iRefNodeId=442)  # [hl]
