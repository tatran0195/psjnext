...
# Desc:    Set the display of the subcase ID in the note window
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/post/Post.SetNote.ResultSubID
# ---
# Prepare Post model
...
# Hide Subcase ID
Post.SetNote.ResultSubID(bNoteResultSubID=False)  # [hl]
