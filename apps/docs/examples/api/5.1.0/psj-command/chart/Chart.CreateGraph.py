...
# Desc:    Make a graph of post result curve
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/chart/Chart.CreateGraph
# ---
...
# Plot chart
newChart = Chart.CreateGraph(crTargetCurve=PostFreqResultCurve(1),   # [hl:start]
                            strChartTitle="Frequency Analysis Displacement", 
                            strAxisTitleX="Frequency", 
                            strAxisTitleY="Amplitude", 
                            bNewChart=False)  # [hl:end]
