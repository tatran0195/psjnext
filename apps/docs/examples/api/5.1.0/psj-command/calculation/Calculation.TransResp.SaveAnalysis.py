...
# Desc:    Save the results of a transient response analysis (*.tsdv)
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/calculation/Calculation.TransResp.SaveAnalysis
# ---
...
# Save Analysis
saveFile = Calculation.TransResp.SaveAnalysis(strPath="C:/temp/TransRespAnalysis.tsdv",   # [hl:start]
                                                crlTargets=[PostTransAnalysis(1)])  # [hl:end]
