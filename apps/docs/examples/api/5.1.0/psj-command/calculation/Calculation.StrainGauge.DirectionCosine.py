...
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/calculation/Calculation.StrainGauge.DirectionCosine
# ---
...
Calculation.StrainGauge.DirectionCosine(ilNodeIDs=[114], dWidth=0.005, dLength=0.01)  # [hl]
