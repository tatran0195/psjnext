...
# Desc:    Display the deformation plot graph
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/calculation/Calculation.FFTAnalysis.CirclePlot
# ---
...
# Circle plot
circlePlot = Calculation.FFTAnalysis.CirclePlot(bOACircle=True, bDefineOA=True)  # [hl]
