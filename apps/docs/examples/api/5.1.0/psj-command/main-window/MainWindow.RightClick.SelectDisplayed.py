...
# Desc:    Select all targets of the same type as the specified target that are displayed in the current document
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/main-window/MainWindow.RightClick.SelectDisplayed
# ---
# Prepare models
Geometry.Part.Cube()
...
displayFaces = MainWindow.RightClick.SelectDisplayed(iTargetType=3)  # [hl]
