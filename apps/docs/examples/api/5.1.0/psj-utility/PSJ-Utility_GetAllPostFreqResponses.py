...
# Desc:    Get all the information of all existing frequency responses
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-utility/PSJ-Utility_GetAllPostFreqResponses
# ---
...
listResponses = JPT.GetAllPostFreqResponses()  # [hl]
