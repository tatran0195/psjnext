...
# Desc:    Show contour of specified mapping data, including multiple data of the same type, on the current model.
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-utility/PSJ-Utility_ShowMultiMappingData
# ---
import os
import csv
import itertools
...
def setup_mapping_view():
    ...
    JPT.ShowMultiMappingData(conv_maps)  # [hl]
