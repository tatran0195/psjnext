...
# Desc:    Get all the information of all custom note collections
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-utility/PSJ-Utility_GetAllCustomNoteCollections
# ---
# Prepare model
