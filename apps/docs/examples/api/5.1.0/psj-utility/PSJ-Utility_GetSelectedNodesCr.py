...
# Desc:    Get all information of the selected nodes under list of cursor format
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-utility/PSJ-Utility_GetSelectedNodesCr
# ---
# Prepare model
...
listCursorSelNodes = JPT.GetSelectedNodesCr()  # [hl]
