...
# Desc:    Get label of a button cell, checkbox cell or combobox cell in the Table
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-gui/dlg-get_cell_label
# ---
from pyjdg import *
