...
# Desc:    Set text's color to the selected/specified cells
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-gui/dlg-set_table_cell_text_color
# ---
from pyjdg import *
...
def on_menu(dlg,name,menu):
    ...
    if menu=="Set Text Color for all selected cells using color picker":
        dlg.set_table_cell_text_color(name="Table1")  # [hl]
    elif menu=="Set Text Color only for a selected cell using color picker":
         dlg.set_table_cell_text_color(name="Table1",  # [hl:start]
