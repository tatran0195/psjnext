...
# Desc:    Add "Face" to the selection list, allowing user to select faces and store the selected faces to the selection list
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-gui/dlg-add_face_selector
# ---
from pyjdg import *
...
def main():
    ...
    dlg.add_space(orientation="horizontal",layout="footer")
    dlg.add_face_selector(text="Face 1")  # [hl]
    dlg.generate_window()
