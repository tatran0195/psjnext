...
# Desc:    Set the width of the specified column in the Table
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-gui/dlg-set_table_column_width
# ---
from pyjdg import *
...
def on_menu(dlg,name,menu):
    ...
    if menu=="Set Column Width using Dialog":
        dlg.set_table_column_width(name="Table1",  # [hl:start]
            col=cellvector[0].col_number)  # [hl:end]
    if menu=="Set Column Width equal 400":
        dlg.set_table_column_width(name="Table1",  # [hl:start]
            col=cellvector[0].col_number,width=400)  # [hl:end]
