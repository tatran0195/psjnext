...
# Desc:    Get the index order of current selected PageItem of the PagesCtrl
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-gui/dlg-get_pagesctrl_current_page
# ---
from pyjdg import *

def on_pageitem_changed(dlg,name,oldpage):
    current_page=dlg.get_pagesctrl_current_page(name="PagesCtrl1")  # [hl]
