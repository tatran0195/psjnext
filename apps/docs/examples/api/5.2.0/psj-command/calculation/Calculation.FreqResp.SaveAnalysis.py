...
# Desc:    Save the results of a frequency response analysis (*.tsdv)
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/calculation/Calculation.FreqResp.SaveAnalysis
# ---
...
Calculation.FreqResp.SaveAnalysis(strPath="C:/temp/TransRespAnalysis.tsdv", crlTargets=[PostFreqAnalysis(1)])  # [hl]
