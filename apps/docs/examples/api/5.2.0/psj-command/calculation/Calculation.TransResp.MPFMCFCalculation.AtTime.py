...
# Desc:    Display MPC result of specific time in Model Participation Factor dialog
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/calculation/Calculation.TransResp.MPFMCFCalculation.AtTime
# ---
...
atTime = Calculation.TransResp.MPFMCFCalculation.AtTime(crResponse=PostTransResultCurve(1), dTime=0.1625)  # [hl]
JPT.Debugger(atTime)
