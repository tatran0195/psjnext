...
# Desc:    Display a graph (a chart) of total MPC
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/calculation/Calculation.TransResp.MPFMCFCalculation.TotalMPC
# ---
...
# Total MPC
totalMPC = Calculation.TransResp.MPFMCFCalculation.TotalMPC(crResponse=PostTransResultCurve(1))  # [hl]
