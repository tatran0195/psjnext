...
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/calculation/Calculation.FreqResp.MPFMCFCalculation.TotalMPC
# ---
...
# Total MPC
totalMPC = Calculation.FreqResp.MPFMCFCalculation.TotalMPC(crResponse=PostFreqResultCurve(3))  # [hl]
