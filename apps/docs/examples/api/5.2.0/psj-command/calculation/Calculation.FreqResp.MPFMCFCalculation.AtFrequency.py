...
# Desc:    Display MPC result of specific frequency in Model Participation Factor dialog
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/calculation/Calculation.FreqResp.MPFMCFCalculation.AtFrequency
# ---
...
atFreq = Calculation.FreqResp.MPFMCFCalculation.AtFrequency(crResponse=PostFreqResultCurve(3), dFrequency=70.0)  # [hl]
JPT.Debugger(atFreq)
