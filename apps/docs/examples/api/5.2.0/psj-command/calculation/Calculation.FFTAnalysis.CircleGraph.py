...
# Desc:    Display the circle graph
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/calculation/Calculation.FFTAnalysis.CircleGraph
# ---
...
# Circle graph
graph = Calculation.FFTAnalysis.CircleGraph(iNewLayer=2)  # [hl]
JPT.Debugger(graph)
