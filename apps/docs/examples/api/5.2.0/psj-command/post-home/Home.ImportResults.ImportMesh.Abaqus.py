...
# Desc:    Import an Abaqus mesh file to the Jupiter Database as Post document to add result to the mesh.
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/post-home/Home.ImportResults.ImportMesh.Abaqus
# ---
...
import_status = Home.ImportResults.ImportMesh.Abaqus(strPath=abaqus_file_path,  # [hl]
