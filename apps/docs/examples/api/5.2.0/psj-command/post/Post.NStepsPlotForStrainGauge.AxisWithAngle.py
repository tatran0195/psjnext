...
# Desc:    Display a graph of the stress/strain at the entered rotation angle from the first defined axis on a two-axis plane
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/post/Post.NStepsPlotForStrainGauge.AxisWithAngle
# ---
# Prepare Post model
...
plot = Post.NStepsPlotForStrainGauge.AxisWithAngle(  # [hl:start]
