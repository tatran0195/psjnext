...
# Desc:    Create initial angular velocity for the general case
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-command/boundary-conditions/BoundaryConditions.InitialNodalValue.InitialAngularVelocity.General
# ---
