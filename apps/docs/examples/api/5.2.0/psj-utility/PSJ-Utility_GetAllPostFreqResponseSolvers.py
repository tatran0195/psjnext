...
# Desc:    Get all the information of all existing Frequency responses (solver)
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-utility/PSJ-Utility_GetAllPostFreqResponseSolvers
# ---
...
listResponses = JPT.GetAllPostFreqResponseSolvers()  # [hl]
