...
# Desc:    Convert DItem object to List of Cursor (Macro string type)
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-utility/PSJ-Utility_DItemToMacroListTCursor
# ---
# Prepare model
Geometry.Part.Cube()
...
JPT.Debugger(JPT.DItemToMacroListTCursor(node))  # [hl]
