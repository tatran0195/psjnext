...
# Desc:    Get all the information of all existing Transient responses (Solver)
# Version: 5.1.0
# Docs:    /docs/cli/5.1.0/psj-utility/PSJ-Utility_GetAllPostTransResponseSolvers
# ---
...
listResponses = JPT.GetAllPostTransResponseSolvers()  # [hl]
