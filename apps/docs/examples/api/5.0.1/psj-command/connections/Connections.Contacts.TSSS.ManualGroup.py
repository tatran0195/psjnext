...
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-command/connections/Connections.Contacts.TSSS.ManualGroup
# ---
Geometry.Part.Cube()
...
Connections.Contacts.TSSS.ManualGroup(strName="ContactSunShine_2", iColor=16711680,  # [hl:start]
    tssolverContact=SUNSHINE_CONTACT(dERROR=1e-06, dFRIC=0.5, dSLIDE=DFLT_DBL, iICOORD=DFLT_INT,
