...
# Desc:    Export the Input Deck for TechnoStar SunShine Linear Buckling analysis (SOL 105)
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-command/analysis/Analysis.TSSS.LinearBuckling
# ---
...
export_status = Analysis.TSSS.LinearBuckling(nastranAnalysis = input_param,  # [hl:start]
                                             strPath = re.sub(re.escape("\\"), "/", environ["Temp"]) + \
                                                       "/TechnoStar/Test.bdf")  # [hl:end]
