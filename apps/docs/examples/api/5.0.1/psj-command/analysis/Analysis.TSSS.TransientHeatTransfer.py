...
# Desc:    Export the Input Deck for TechnoStar SunShine Transient Heat Transfer analysis (SOL 159)
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-command/analysis/Analysis.TSSS.TransientHeatTransfer
# ---
...
export_status = Analysis.TSSS.TransientHeatTransfer(nastranAnalysis = input_param,   # [hl]
