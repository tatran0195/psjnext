...
# Desc:    Export the input file for Nastran Linear Buckling Analysis (SOL 105)
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-command/analysis/Analysis.Nastran.LinearBuckling
# ---
Geometry.Part.Cube()
...
Analysis.Nastran.LinearBuckling(nastranAnalysis= nastran_param,strPath="D:/Job_1.bdf")  # [hl]
