...
# Desc:    Export the Input Deck for TechnoStar Transient Heat Transfer analysis (SOL 159)
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-command/analysis/Analysis.TSSolver.TransientHeatTransfer
# ---
...
export_status = Analysis.TSSolver.TransientHeatTransfer(nastranAnalysis = input_param,   # [hl]
