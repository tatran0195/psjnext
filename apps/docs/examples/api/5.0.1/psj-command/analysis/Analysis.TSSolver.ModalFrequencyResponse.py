...
# Desc:    Export the Input Deck for TechnoStar Modal Frequency Response analysis (SOL 111)
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-command/analysis/Analysis.TSSolver.ModalFrequencyResponse
# ---
...
export_status = Analysis.TSSolver.ModalFrequencyResponse(nastranAnalysis = input_param,   # [hl]
