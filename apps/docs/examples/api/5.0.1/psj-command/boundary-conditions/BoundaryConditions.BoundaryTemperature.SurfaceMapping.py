...
# Desc:    Create surface mapping boundary temperature
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-command/boundary-conditions/BoundaryConditions.BoundaryTemperature.SurfaceMapping
# ---
