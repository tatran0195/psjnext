...
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-command/boundary-conditions/BoundaryConditions.InitialTemperature.ADVC
# ---
import os
...
created_bcs = BoundaryConditions.InitialTemperature.ADVC(strFilePathName = temp_folder \  # [hl]
                                                                           + "/test.adx",   # [hl]
