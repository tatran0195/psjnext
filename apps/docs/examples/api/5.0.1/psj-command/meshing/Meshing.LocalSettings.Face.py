...
# Desc:    Set the mesh setting for the selected faces (Define the settings before surface mesh creation)
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-command/meshing/Meshing.LocalSettings.Face
# ---
Geometry.Part.Cube()

local_mesh = Meshing.LocalSettings.Face(strName="MeshParam_1",   # [hl]
