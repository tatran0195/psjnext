...
# Desc:    Import a Nastran file (*.bdf) to the Jupiter Database (Mesh, boundary conditions, etc.)
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-command/home/Home.ImportMesh.NastranBdf
# ---
...
import_status = Home.ImportMesh.AnsysDat(strlPaths=[nastran_file_path])  # [hl]
