...
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-gui/dlg-set_table_cell_alignment
# ---
from pyjdg import *
...
def main():
    ...
    dlg.set_cell_value(name="Table1",cell_row_id=0,
        cell_column_id=0,value="Left Alignment")
    dlg.set_cell_value(name="Table1",cell_row_id=1,
        cell_column_id=0,value="Center Alignment")
    dlg.set_cell_value(name="Table1",cell_row_id=2,
        cell_column_id=0,value="Right Alignment")
