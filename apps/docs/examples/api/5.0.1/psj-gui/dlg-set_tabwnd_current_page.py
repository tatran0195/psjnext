...
# Desc:    Set the current page of the TabWnd to a specific TabItem order
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-gui/dlg-set_tabwnd_current_page
# ---
from pyjdg import *
...
def main():
    ...
    dlg.add_space(orientation="horizontal",layout="footer")
    dlg.generate_window()
    dlg.set_tabwnd_current_page(name="TabWnd2",page_index=2)  # [hl]
