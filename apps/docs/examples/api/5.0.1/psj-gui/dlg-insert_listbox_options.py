...
# Desc:    Insert multiple options to a specific position of the ListBox component
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-gui/dlg-insert_listbox_options
# ---
from pyjdg import *
...
def main():
    ...
    dlg.add_space(orientation="horizontal",layout="footer")
    dlg.generate_window()
    dlg.insert_listbox_options(name="ListBox2",position=2,options=["item_New_2","item_New_1"])  # [hl]
