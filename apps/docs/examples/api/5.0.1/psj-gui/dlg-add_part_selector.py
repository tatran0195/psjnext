...
# Desc:    Add "Part" to the selection list, allowing user to select parts and store the selected parts to the selection list
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-gui/dlg-add_part_selector
# ---
from pyjdg import *
