...
# Desc:    Get all information of the shared elements
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-utility/PSJ-Utility_GetSharedElements
# ---
# Prepare model
...
listSharedElems = JPT.GetSharedElements(listParts)  # [hl]
