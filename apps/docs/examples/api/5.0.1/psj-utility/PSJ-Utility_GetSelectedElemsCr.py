...
# Desc:    Get all information of the selected elements under list of cursor format
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-utility/PSJ-Utility_GetSelectedElemsCr
# ---
# Prepare model
...
listCursorSelElems = JPT.GetSelectedElemsCr()  # [hl]
