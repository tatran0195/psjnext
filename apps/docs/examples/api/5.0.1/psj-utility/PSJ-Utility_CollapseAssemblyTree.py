...
# Desc:    Collapse all the items existing on the Assembly window
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-utility/PSJ-Utility_CollapseAssemblyTree
# ---
# Preparing tree
Geometry.Part.Cube()
