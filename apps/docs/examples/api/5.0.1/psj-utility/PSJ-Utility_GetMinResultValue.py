...
# Desc:    Get the minimum value of the current plotting result
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-utility/PSJ-Utility_GetMinResultValue
# ---
# Prepare model
...
minResult = JPT.GetMinResultValue()  # [hl]
