...
# Desc:    Get all the information of all existing connections
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-utility/PSJ-Utility_GetAllConnections
# ---
# Prepare model
...
listDConnections = JPT.GetAllConnections()  # [hl]
