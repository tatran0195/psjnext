...
# Desc:    Get all information of the selected parts under list of cursor format
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-utility/PSJ-Utility_GetSelectedPartsCr
# ---
# Prepare model
...
listCursorSelParts = JPT.GetSelectedPartsCr()  # [hl]
