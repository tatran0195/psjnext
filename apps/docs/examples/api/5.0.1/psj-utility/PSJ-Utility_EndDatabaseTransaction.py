...
# Desc:    Similar to a close bracket of the JPT.BeginDatabaseTransaction() utility. After using this utility, all the steps behind this utility will not be stored to the JPT.BeginDatabaseTransaction() utility
# Version: 5.0.1
# Docs:    /docs/cli/5.0.1/psj-utility/PSJ-Utility_EndDatabaseTransaction
# ---
