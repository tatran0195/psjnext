...
const STUDIO_PATHS = [
    {
        ...
        cn: 'fill-[#737373] dark:fill-[#424242] group-hover/row:fill-black dark:group-hover/row:fill-[#858586]',
    },
    {
        d: 'M13 6a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm-3 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm-3 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0z',
        cn: 'fill-[#b9b9b9] dark:fill-[#737373] group-hover/row:fill-[#cccccc] dark:group-hover/row:fill-[#f9fafb]',
    },
    {
        ...
        cn: 'fill-[#9d9d9d] dark:fill-[#565656] group-hover/row:fill-[#818283] dark:group-hover/row:fill-[#b3b4b5]',
    },
    {
...
export const StudioIcon = () => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
        {STUDIO_PATHS.map(({ d, cn }) => (
            <path key={d} d={d} className={`transition-[fill] duration-150 ease-in-out ${cn}`} />
        ))}
    </svg>
);
...
export const PlayIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden>
        <path
            ...
            strokeLinejoin="round"
            strokeWidth="1.5"
            className="fill-[#c4c4c4] dark:fill-[#333333] group-hover/row:fill-current transition-[fill] duration-150"
