        ...
        <button
            ...
            className={cn(
                buttonVariants({
                    color: 'ghost',
                    size: 'icon-md',
                    className: 'gap-2 [&_svg]:size-4 [&_svg]:text-fd-muted-foreground',
                }),
                props.className,
            )}
        >
            {isLoading ? <Loader2 className="animate-spin" /> : checked ? <Check /> : <Copy />}
            {props.children}
        </button>
    );
}
            ...
            <PopoverContent className="flex flex-col">
                {items.map((item) => (
                    <a
                        ...
                        target="_blank"
                        className="text-sm p-2 rounded-none inline-flex items-center gap-2 hover:text-fd-accent-foreground hover:bg-fd-accent [&_svg]:size-4"
                    >
                        {item.icon}
                        {item.title}
