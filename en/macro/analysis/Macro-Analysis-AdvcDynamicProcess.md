...
```psj
AdvcDynamicProcess(string m_strName,int m_iGeomNonlinear,int fixed_or_auto,int num_of_inc,
    ...
    double rdnlk_stra_tol,bool m_bDynamic,double alpha,double beta,double gamma,Cursor m_crEdit,
    list m_LoadNodeList,list m_LoadCaseNodeList,list m_LoadNodeContactList,list m_OutputParamList,
